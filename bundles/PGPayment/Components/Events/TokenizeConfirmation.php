...
/**
 * Class TokenizeConfirmation
 * @package PGPayment\Components\Events
 */
class TokenizeConfirmation extends AbstractEvent
{
    ...
    public function __construct(OrderEntityInterface $order, array $transactions)
    {
        $this->order = $order;
    ...
    {
        return 'ORDER.TOKENIZE_CONFIRMATION';
    }
